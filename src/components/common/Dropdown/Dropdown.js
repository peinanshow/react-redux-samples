...
class Dropdown extends Component {
  ...
  state = { isExpanded: this.props.expanded, mouseHover: false};
  ...
  handleOnMouseOver = ()=> this.setState({ mouseHover: true });

  handleOnMouseOut = ()=> this.setState({ mouseHover: false });

  // RENDER COMPONENT

  render() {
    const { isExpanded, mouseHover } = this.state;
